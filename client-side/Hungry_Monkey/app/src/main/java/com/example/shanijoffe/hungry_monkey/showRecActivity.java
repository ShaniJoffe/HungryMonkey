...
public class showRecActivity extends AppCompatActivity {
    ...
    String[] teams={""};
    String name_res="",name_dish="",imgUrl="",kosher="",rest_address="",dish_desc="",location_res_str="",price_dish="",dish_id_inRest="";
...
//            String matchFound = "N";
            ...
            try {
                ...
                Log.e("in get rec","in exec getrec");
               ...
               // Log.e("in get rec","response code"+ conn.getResponseCode() );
                Log.e(" r Code :: " , String.valueOf(conn.getResponseCode()));
                if (conn.getResponseCode() == HttpURLConnection.HTTP_OK) { // success
                    ...
                    in.close();
                    // print result
                   log.e("response:","rec for user"+response);
