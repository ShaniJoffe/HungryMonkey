     ...
     //   seekBar_distance = new CrystalSeekbar(getActivity());//for distance
        ...
        search_adv.setOnQueryTextListener( new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                // your text view here
                Log.i("asked is", String.valueOf( asked ) );
...
//                    Toast.makeText(getActivity(), "text " + bundle , Toast.LENGTH_LONG).show();
                    if(bundle==null)
                    {
                        lon = 0.0;
                        lat = 0.0;
                        Log.i("bundle recived null we put 0.0","0.0");
                    }
                    else
                        {
//                        lon = Double.parseDouble(String.valueOf( bundle.get( "lon" ) ));
...
//            Looper.prepare();
            ...
            try {
                ...
                search_adv.setVisibility(View.GONE);
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        }
...
//                dish_inp.put( "lon", 35.310381 );
                URL url2 = new URL( "http://newapp-env.eiymf2wfdn.eu-central-1.elasticbeanstalk.com/api/v1/advancedSearch" ); // here is your URL path

                postDataParams_adv2 = new JSONObject(); //  advanced  search json object.

                postDataParams_adv2.put( "lat", postDataParams_adv.getString("lat") );

                postDataParams_adv2.put( "lon", postDataParams_adv.getString("lon") );
                postDataParams_adv2.put( "minPrice", postDataParams_adv.getString("minPrice") );
                postDataParams_adv2.put( "maxPrice", postDataParams_adv.getString("maxPrice") );
                postDataParams_adv2.put( "distance", postDataParams_adv.getString("distance"));
                postDataParams_adv2.put( "restKosher",     postDataParams_adv.getString("restKosher") );
                postDataParams_adv2.put( "dishName", postDataParams_adv.getString("dishName") );


              //  Log.e( "sending to adv", postDataParams_adv.toString() ); //json object advanced
                Log.e( "sending to adv2", postDataParams_adv2.toString() ); //json object advanced
               ...
               // writer.write( getPostDataString( postDataParams_adv) ); //post the object
                writer.write( getPostDataString( postDataParams_adv2 ) ); //post the object
                writer.flush();
                writer.close();
                os.close();
                 responseCode = conn.getResponseCode();
