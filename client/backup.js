...
$(document).ready(function() {
  ...
  $(add_button).click(function(e){ //on add input button click
    ...
    if(x < max_fields){ //max input box allowed
      ...
      $(wrapper).append("	<br><span name='"+x+"'><label for='menu["+x+"][dish_cat]'>:קטגוריה</label>"
      +"<input type='text' name='menu["+x+"][dish_cat]' placeholder='קטגוריה'><br>"
      +"<label for='menu["+x+"][dish_name]'>:מנה</label>"
      +"<input type='text' name='menu["+x+"][dish_name]' placeholder='שם המנה'><br>"
      +"<label for='menu["+x+"][dish_description]'>:תיאור המנה</label>"
      +"<input type='text' name='menu["+x+"][dish_description]'placeholder='תיאור המנה'><br>"
